      ...
      public Query parse() throws SyntaxError {
        ...
        try {
          if (fromIndex != null && !fromIndex.equals(req.getCore().getCoreDescriptor().getName()) ) {
            ...
            jq = JoinUtil.createJoinQuery(fromField, multipleValuesPerDocument , toField, fromQuery, req.getSearcher(), scoreMode);
          //JoinQuery jq = new JoinQuery(fromField, toField, fromIndex, fromQuery);
            //jq.fromCoreOpenTime = fromCoreOpenTime; TODO
          }
        } catch (IOException e) {
        ...
        final WrappedQuery wrappedQuery = new WrappedQuery(jq);
...
class JJoinQuery extends Query {
  String fromField;
  String toField;
  String fromIndex;
  Query q;
  ...
  public JJoinQuery(String fromField, String toField, String fromIndex, Query subQuery) {
    ...
    public Scorer scorer(AtomicReaderContext context, boolean scoreDocsInOrder,
      ...
      if (filter == null) {
        ...
        if (debug) {
          ...
          rb.addDebug(dbg, "join", JJoinQuery.this.toString());
        }
